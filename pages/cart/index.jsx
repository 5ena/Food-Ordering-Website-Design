...
const Cart = ({ userList }) => {
  ...
  return (
    ...
    <div className="max-h-52 overflow-auto w-full">
              ...
              <table className="w-full text-sm text-center text-gray-500 min-w-[1000px]">
                ...
                <tbody>
                  {cart.products.map((product, index) => (
                    <tr
                      className="transition-all bg-green-950 border-gray-700 hover:bg-primary"
                      key={index}
                    >
        ...
        <div className="bg-green-950 min-h-[calc(100vh_-_433px)] flex flex-col justify-center text-white p-12 md:w-auto w-full   md:text-start !text-center">          <Title addClass="text-[40px]">CART TOTAL</Title>
